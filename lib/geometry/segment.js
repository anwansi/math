...
class Segment {
    ...
    projectIntersection(fragment) {
        ...
        // We could use "fragment instanceof Circle", but then we'd have to
        // import the Circle class, and then it would be just defensible
        // to let Circle import Segment, leading to a circular dependency.
        // Let's just duck type instead.
        if (('radius' in fragment) && ('centerPoint' in fragment)) {
            const ixPoints = [];
